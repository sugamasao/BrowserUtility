...
// ua list. for http://www.openspc2.org/userAgent/
...
private var safariList:Array = [
        ...
        {ua:'Mozilla/5.0 (Macintosh; U; PPC Mac OS X; ja-jp) AppleWebKit/412.6.2 (KHTML, like Gecko) Safari/125.11', ver:2.0}, 
		...
		*******************************************************/
		...
		public function UserAgentIsSafariTest():void {
			...
			for each(var obj:Object in safariList) {
				b = new Browser(obj.ua);
				trace("safari", b.isSafari, " ua =>", obj.ua)
